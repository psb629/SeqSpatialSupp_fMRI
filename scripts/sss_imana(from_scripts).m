...
% edit sss_heuristic.py, change S01 -> SXc
...
switch(what)
    ...
    case 'WB:vol2surf_stats' % perform group stats on surface (.gifti)
        ...
        vararginoptions(varargin,{'glm','map'});
    ...
    case 'HRF:ROI_hrf_plot'                 % Plot extracted time series
        ...
        subj_id = pinfo.subj_id{pinfo.sn==sn};fi([], 1, 16)
    ...
    case 'ROI:getpsc' % use this...
        ...
        for s=sn % for each subj
            ...
            %                 };
            % O = {'psc_BothRep-CueOnly-L.nii','psc_BothRep-CueOnly-S.nii'};
            % load ROI
    ...
    case 'ROI_get_prewhitened_beta'         % ROI MVA 1: Extracts raw timeseries and get prewhitened beta
        glm = 3;
        roi = [1:10];
        ...
        %        varargout = Data;
    case 'ROI_calc_rdm'         % ROI MVA 1: Extracts raw timeseries and get prewhitened beta
        glm = 3;
        roi = [1:11];
        %         normmode = 'runwise';
